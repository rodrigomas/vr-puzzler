...
public class lightUp : MonoBehaviour {
	...
	void Start () {
        ...
        this.GetComponentInChildren<ParticleSystem>().Stop(); //Start without emitting particles
	...
	public void gazeLightUp() {
		...
		this.GetComponentInChildren<ParticleSystem>().Play(); //Turn on particle emmission
