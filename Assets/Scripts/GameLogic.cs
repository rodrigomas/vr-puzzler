...
public class GameLogic : MonoBehaviour
{
    ...
    public GameObject startUI, restartUI, aboutUI;
    ...
    public GameObject SuccesAudioHolder;
    ...
    { //Invoked repeating.
        ...
        foreach(GameObject obj in puzzleSpheres)
        {
            obj.GetComponent<lightUp>().aestheticReset();
        }
    ...
    { //Do this when the player gets it right
        ...
        SuccesAudioHolder.GetComponent<GvrAudioSource>().Play();
    }
